Feature: Establecer precios justos y competitivos para obras de arte

  Scenario: E01 - Como cliente, quiero poder establecer precios justos y competitivos para mis obras de arte en la plataforma
    Given que soy un artista registrado en la plataforma
    And he cargado una obra de arte para vender
    ...
    And me aseguro de recibir una compensación adecuada por mi trabajo
